...
const capsAndApparelSampleImages = Object.entries(import.meta.glob('/src/assets/images/capsAndApparel/*.{png,jpg,jpeg}', { eager: true }) as Record<string, { default: string }>)
