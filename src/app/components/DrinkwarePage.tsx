...
const drinkwareSampleImages = Object.entries(import.meta.glob('/src/assets/images/drinkware/sample/*.{png,jpg,jpeg}', { eager: true }) as Record<string, { default: string }>)
