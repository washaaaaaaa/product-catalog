...
const kitchenwareSampleImages = Object.entries(import.meta.glob('/src/assets/images/kitchenware/sample/*.{png,jpg,jpeg}', { eager: true }) as Record<string, { default: string }>)
