...
const umbrellasAndBagsSampleImages = Object.entries(import.meta.glob('/src/assets/images/umbrellasAndBags/*.{png,jpg,jpeg}', { eager: true }) as Record<string, { default: string }>)
